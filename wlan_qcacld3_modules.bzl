...
def _define_module_for_target_variant_chipset(target, variant, chipset):
    ...
    copts.append("-Wno-implicit-fallthrough")
    copts.append("-Wno-visibility")
    copts.append("-fstrict-flex-arrays=0")
    copts.append("-Wframe-larger-than=2048")
    copts.append("-include")
    ...
    out = "wlan.ko"
    kconfig = "Kconfig"
    defconfig = "configs/mdm9607_qca9377_defconfig"
