...
CDEFINES += -DDFS_FALSE_DETECT_DUR_CHECK
endif
...
CDEFINES += -DWLAN_CMD_SERIALIZATION_LOCKING
...
CDEFINES += -DCFG80211_EXTERNAL_AUTH_SUPPORT
CDEFINES += -DCFG80211_EXTERNAL_AUTH_AP_SUPPORT
CDEFINES += -DCFG80211_EXTERNAL_DH_UPDATE_SUPPORT
