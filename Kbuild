...
ifeq ($(CONFIG_WLAN_GET_TEMP), y)
HDD_OBJS += $(HDD_SRC_DIR)/wlan_hdd_sysfs_get_temp.o
endif
...
cppflags-y += -DCFG80211_EXTERNAL_AUTH_SUPPORT
cppflags-y += -DCFG80211_EXTERNAL_AUTH_AP_SUPPORT
cppflags-y += -DCFG80211_EXTERNAL_DH_UPDATE_SUPPORT
