...
CONFIG_WMA_FW_RESPONSE_TIME_INCREASE ?= 0
ccflags-y += -DWMA_FW_RESPONSE_TIME_INCREASE=$(CONFIG_WMA_FW_RESPONSE_TIME_INCREASE)
...
ifeq ($(CONFIG_KERNEL_4_19_SUPPORT), y)
cppflags-y += -DKERNEL_4_19_SUPPORT
endif
